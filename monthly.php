...
<body>
    ...
    <h1>
        ...
        <br>
        <button style="font-size: 25px; text-align: center" onclick="location.href = 'site_lookup.php'">Go To Site Lookup</button>
    </h1>
...
<table>
    ...
    if(!isset($_COOKIE['sessionID'])) {
        ...
        foreach($keys as $row => $key){
            ...
            echo "<td style='padding-top: 1%'><form action='monthly.php' id='done' method='post'><input name='done' type='submit' value=" . $key['id_number'] . "></form></td>";
            echo "</h3></tr>";
        }
        ...
        if ($_POST['done']) {
            ...
            if ($done['fip'] == "Yes") {
                ...
                $change = $pdo->query("UPDATE accounts SET monthly = NULL WHERE id_number IS " . $_POST['done']);
