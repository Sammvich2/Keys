...
<table>
    ...
    <?php
        ...
        if ($_POST['done']) {
            ...
            if ($done['fip'] == "Yes") {
                $change = $pdo->query("UPDATE keys SET fip = ")
            }
        ...
        foreach($keys as $row => $key){
            ...
            echo "<td style='padding-top: 1%'><form action='monthly.php' method='post'><input  type='submit' name='done' value=" . $key['id_number'] . "></form></td>";
